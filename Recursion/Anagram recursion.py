##By: Benji Saltz
##Date March 27, 2018
##Description: Program finds all anagrams and if one sequence of letters you enter is an anagram
...
def ana(word2):
    ...
    if len(word2)==0:
        ...
        lst=[]
        for i in ana(word2[1:]): #Sequence creates anagrams and puts them into a list
